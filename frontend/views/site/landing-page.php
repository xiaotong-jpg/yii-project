...
<div class="witr_swiper_area">
         <div class="swiper-container swiper_active">
            <div class="swiper-wrapper">
               <!-- 1 single slider -->
               <div class="swiper-slide d1 t1 m1 witr_swiper_height" style="background-image: url(<?= Url::to('@web/assets/images/slider1.') ?>);">
      ...
      <!-- about area  -->
      <div class="lorw_about_area" id="about">
         <div class="container ">
            <div class="row">
      ...
      <!-- feature area -->
      <div class="lorw_feature_area" id="service">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                  <div class="witr_section_title">
      ...
      <!-- lorw team area -->
      <div class="lorw_team_area" id="team">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                  <div class="col-lg-12">
      ...
      <div class="lorw_testimonial_area" id="clients">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                  <div class="witr_section_title">
      ...
      <!-- lorw portfolio area -->
      <div class="lorw_portfolio_area pstyle2 pstyle_1 port_area" id="project">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                  <div class="witr_section_title">
      ...
      <!-- contact area css -->
      <div class="lorw_contact_area" id="contact">
         <div class="container">
            <div class="row">
      ...
      <!-- lorw blog area -->
      <div class="lorw_blog_area" id="blog">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                  <div class="witr_section_title">
