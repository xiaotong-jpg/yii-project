               ...
               <div class="col-md-12 txtc  text-center ccase">
                  ...
                  <div class="breadcumb-inner">
                     <ul>
                        ...
                        <li><span class="current">Blog Right Sidebar</span></li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-lg-8 col-md-7 col-sm-12 col-xs-12">
                  <div class="row">
                           ...
                           <div class="em-blog-content-area">
                              ...
                              <div class="blog-inner">
                                 <div class="blog-content">
                                    <p>Our offices are located on the trad, unced. photo booth stumptown to banksy, elit small batch freeganâ€?How to Attain Process Automation Satisfaction. Naturally, the appeal of Robot for its market potential cannot </p>
                                 </div>
                              </div>
                     ...
                     <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="lorw-blog-meta post_blog">
                           <h2><a href="<?= Url::to(['/site/single-blog']) ?>">Netflixâ€™s â€œOrange Is the New Blackâ€?Brings</a></h2>
                           <div class="lorw-blog-meta">
                              <div class="lorw-blog-meta-left">			
                                 <span><i class="fas fa-calendar-alt"></i>04 January , 2022</span>
                                 <a href="#"><i class="fas fa-comment"></i>0 Comments</a>						
                        ...
                        <div class="lorw-single-blog lorw-lt">
                           ...
                           <div class="wp-block-group__inner-container">
                              <blockquote class="wp-block-quote has-text-align-center is-style-large">
                                 <p>â€œDo you see over yonder, friend Sancho, thirty or forty hulking giants? I intend to do battle with them and slay them.â€?/p>
                                 <cite>â€?Don Quixote</cite>
                              </blockquote>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="single-widget-item">
                           ...
                           <div class="recent-post-item">
                              <div class="recent-post-image">
                                 <a href="#"><img src="<?= Url::to('@web/assets/images/blogs1.jpg') ?>"alt="image" /></a>
                              </div>
                           ...
                           <div class="recent-post-item">
                              <div class="recent-post-image">
                                 <a href="#"><img src="<?= Url::to('@web/assets/images/blogs2.jpg') ?>"alt="image" /></a>
                              </div>
                              <div class="recent-post-text">
                           ...
                           <div class="recent-post-item">
                              <div class="recent-post-image">
                                 <a href="#"><img src="<?= Url::to('@web/assets/images/blogs3.jpg') ?>"alt="image" /></a>
                              </div>
                              <div class="recent-post-text">
