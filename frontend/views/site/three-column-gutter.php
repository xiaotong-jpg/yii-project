...
$this->title = 'Three Column Gutter';
...
<!-- breadcumb area -->
               ...
               <div class="col-md-12 txtc  text-center ccase">
                  ...
                  <div class="breadcumb-inner">
                     <ul>
                        ...
                        <li><span class="current">Three-Column Gutter</span></li>
                     </ul>
                  </div>
               </div>
            </div>
      ...
      <!-- End breadcumb area -->  
      <!-- portfolio area -->
      <div class="lorw_portfolio_area project_area port_2coloumn port_gutter_area port_mpd">
         <div class="container-fluid">
            ...
            <div class="row portfolio_active pstyle2">
               <!-- 01 single portfolio -->
               <div class="col-lg-4 col-md-6 witr_all_pd0 grid-item business_law family_law">
               ...
               <!-- 02 single portfolio -->
               <div class="col-lg-4 witr_all_pd0 col-md-6 grid-item business_law finalcial_low">
                  <div class="single_protfolio">
                     <div class="prot_thumb">
               ...
               <!-- 03 single portfolio -->
               <div class="col-lg-4 col-md-6 witr_all_pd0 grid-item family_law finalcial_low">
                  <div class="single_protfolio">
                     <div class="prot_thumb">
               ...
               <!-- 04 single portfolio -->
               <div class="col-lg-4 col-md-6 witr_all_pd0 grid-item business_law finalcial_low">
                  <div class="single_protfolio">
                     <div class="prot_thumb">
               ...
               <!-- 05 single portfolio -->
               <div class="col-lg-4 col-md-6 witr_all_pd0 grid-item family_law technology_low">
                  <div class="single_protfolio">
                     <div class="prot_thumb">
