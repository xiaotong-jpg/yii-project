            ...
            <div class="row">
               <div class="col-lg-8 col-md-7 col-sm-12">
                  ...
                  <div class="single_blog single_blog_grid singles">
                     ...
                     <!-- BLOG TITLE -->
                     <div class="lorw-single-blog-details-inner">
                        <div class="lorw-single-blog-title">
                           <h2>What Will Nonprofit Be Like In The Next 50 Years?</h2>
                        </div>
                        <div class="lorw-blog-meta">
                           <div class="lorw-blog-meta-left">
                              <span><i class="fas fa-calendar-alt"></i>04 September , 2022</span>
                              <a href="#"><i class="fas fa-user"></i> lorw</a>
                              <a href="#"><i class="fas fa-comment"></i>0 Comments</a>						
                           </div>
                        </div>
                        <div class="lorw-single-blog-content">
                        ...
                        <div class="lorw-blog-social">
                           <div class="lorw-single-icon">
                              <div class="lorw-single-icon-inner">
                  ...
                  <div class="comments-area">
                     <div class="comment-respond ">
                        ...
                        <form action="mail.php" method="post" id="contact-form">
                           ...
                           <button type="submit"  name="ok" class="lorw_btn" >Post Comment</button> 
                           <div class="row">
