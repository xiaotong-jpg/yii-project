               ...
               <div class="col-lg-12">
                  <div class="em-nivo-slider-wrapper">
                     <div id="mainSlider_id2" class="nivoSlider em-slider-image">		
                        <img src="<?= Url::to('@web/images/slider1.') ?>"alt="image" title="#htmlcaption1_3936" >				   
                        <img src="<?= Url::to('@web/images/slider2.') ?>"alt="image" title="#htmlcaption1_3935" >
                     </div>
                  ...
                  <div class="lorw_about_image_inner">
                     <div class="single_image_area">
                        <div class="single_image single_line_option  ">
                           <img src="<?= Url::to('@web/images/about-thumb1.') ?>"alt="image" />
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="service-item all_color_service text-left">
                     <div class="service_top_image"> 
                        <img src="<?= Url::to('@web/images/f1.') ?>"alt="image" />
                     </div>
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="service-item all_color_service text-left">
                     <div class="service_top_image"> 
                        <img src="<?= Url::to('@web/images/f2.') ?>"alt="image" />
                     </div>
                     <div class="text_box all_icon_color">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="service-item all_color_service text-left">
                     <div class="service_top_image"> 
                        <img src="<?= Url::to('@web/images/f3.') ?>"alt="image" />
                     </div>
                     <div class="text_box all_icon_color">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="service-item all_color_service text-left">
                     <div class="service_top_image"> 
                        <img src="<?= Url::to('@web/images/f4.') ?>"alt="image" />
                     </div>
                     <div class="text_box all_icon_color">
                     ...
                     <div class="brand_active">
                        ...
                        <div class="col-lg-12">
                           <div class="slide_items  ">
                              <a href="#"><img src="<?= Url::to('@web/images/br1.') ?>"alt="image"></a>
                           </div>
                        </div>
                        <!-- 02 single brand -->
                        <div class="col-lg-12">
                           <div class="slide_items  ">
                              <a href="#"><img src="<?= Url::to('@web/images/br2.') ?>"alt="image"></a>
                           </div>
                        </div>
                        <!-- 03 single brand -->
                        <div class="col-lg-12">
                           <div class="slide_items  ">
                              <a href="#"><img src="<?= Url::to('@web/images/br3.') ?>"alt="image"></a>
                           </div>
                        </div>
                        <!-- 04 single brand -->
                        <div class="col-lg-12">
                           <div class="slide_items  ">
                              <a href="#"><img src="<?= Url::to('@web/images/br4.') ?>"alt="image"></a>
                           </div>
                        </div>
                        <!-- 05 single brand -->
                        <div class="col-lg-12">
                  ...
                  <div class="choose_img_inner">
                     <div class="single_image_area">
                        <div class="single_image"> 
                           <img src="<?= Url::to('@web/images/skill-thumb1.') ?>"alt="image" />
                        </div>
                     </div>
                  </div>
               </div>
                           ...
                           <div class="row">
                              <div class="col-lg-6 col-md-6">
                                 <div class="single_image_area tab_content_one">
                                    <div class="single_image single_line_option  ">
                                       <img src="<?= Url::to('@web/images/tab-thumb.') ?>"alt="image" />
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-6 col-md-6">
         ...
         <div class="container">
            ...
            <div class="row team_active">
               ...
               <div class="witr_all_mb_30 col-md-12 col-xs-12 col-sm-12 col-lg-12">
                  <div class=" all_color_team ">
                     <div class="witr_team_section"> 
                        <img src="<?= Url::to('@web/images/team-04.') ?>"alt="image" />
                     </div>
               ...
               <div class="witr_all_mb_30 col-md-12 col-xs-12 col-sm-12 col-lg-12">
                  <div class=" all_color_team ">
                     <div class="witr_team_section"> 
                        <img src="<?= Url::to('@web/images/team-05.') ?>"alt="image" />
                     </div>
                     <div class="post_team_content">
                        <div class="post_team_icon_9 all_team_icon_o_color">
                           <ul class="witr_pots_team_s">
               ...
               <div class="witr_all_mb_30 col-md-12 col-xs-12 col-sm-12 col-lg-12">
                  <div class=" all_color_team ">
                     <div class="witr_team_section"> 
                        <img src="<?= Url::to('@web/images/team-06.') ?>"alt="image" />
                     </div>
                     <div class="post_team_content">
                        <div class="post_team_icon_9 all_team_icon_o_color">
                           <ul class="witr_pots_team_s">
               ...
               <div class="col-lg-12 ">
                  <div class=" testimonial_active witr_testi_s10">
                     ...
                     <div class="witr_testi_itemt testi-width all_color_testimonial">
                        <div class="em_single_testimonial">
                           <div class="em_test_thumb test-part">
                              <img src="<?= Url::to('@web/images/testi-01.') ?>"alt="image">
                           </div>
                     ...
                     <div class="witr_testi_itemt testi-width all_color_testimonial">
                        <div class="em_single_testimonial">
                           <div class="em_test_thumb test-part">
                              <img src="<?= Url::to('@web/images/testi-02.') ?>"alt="image">
                           </div>
                           <div class="em_testi_title">
                     ...
                     <div class="witr_testi_itemt testi-width all_color_testimonial">
                        <div class="em_single_testimonial">
                           <div class="em_test_thumb test-part">
                              <img src="<?= Url::to('@web/images/testi-03.') ?>"alt="image">
                           </div>
                           <div class="em_testi_title">
                              ...
                              <div class="prot_thumb">
                                 ...
                                 <div class="prot_content">
                                    <div class="prot_content_inner">
                                       <div class="picon"> <a class="portfolio-icon venobox vbox-item" data-gall="myGallery" href="<?= Url::to('@web/images/p1.') ?>"><i class="icofont-image"></i></a></div>
                                    </div>
                                 </div>
                              </div>
                        ...
                        <div class="grid-item col-lg-4 col-md-6 col-xs-12 col-sm-12 witr_all_mb_30 business_law finalcial_low">
                           <div class="single_protfolio">
                              <div class="prot_thumb">
                                 ...
                                 <div class="prot_content">
                                    <div class="prot_content_inner">
                                       <div class="picon"> <a class="portfolio-icon venobox vbox-item" data-gall="myGallery" href="<?= Url::to('@web/images/p2.') ?>"><i class="icofont-image"></i></a></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="pprotfolio4">
                        ...
                        <div class="grid-item col-lg-4 col-md-6 col-xs-12 col-sm-12 witr_all_mb_30 family_law finalcial_low">
                           <div class="single_protfolio">
                              <div class="prot_thumb">
                                 ...
                                 <div class="prot_content">
                                    <div class="prot_content_inner">
                                       <div class="picon"> <a class="portfolio-icon venobox vbox-item" data-gall="myGallery" href="<?= Url::to('@web/images/p3.') ?>"><i class="icofont-image"></i></a></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="pprotfolio4">
                        ...
                        <div class="grid-item col-lg-4 col-md-6 col-xs-12 col-sm-12 witr_all_mb_30 business_law finalcial_low">
                           <div class="single_protfolio">
                              <div class="prot_thumb">
                                 ...
                                 <div class="prot_content">
                                    <div class="prot_content_inner">
                                       <div class="picon"> <a class="portfolio-icon venobox vbox-item" data-gall="myGallery" href="<?= Url::to('@web/images/p4.') ?>"><i class="icofont-image"></i></a></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="pprotfolio4">
                        ...
                        <div class="grid-item col-lg-4 col-md-6 col-xs-12 col-sm-12 witr_all_mb_30 technology_low">
                           <div class="single_protfolio">
                              <div class="prot_thumb">
                                 ...
                                 <div class="prot_content">
                                    <div class="prot_content_inner">
                                       <div class="picon"> <a class="portfolio-icon venobox vbox-item" data-gall="myGallery" href="<?= Url::to('@web/images/p5.') ?>"><i class="icofont-image"></i></a></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="pprotfolio4">
                        ...
                        <div class="grid-item col-lg-4 col-md-6 col-xs-12 col-sm-12 witr_all_mb_30 technology_low">
                           <div class="single_protfolio">
                              <div class="prot_thumb">
                                 ...
                                 <div class="prot_content">
                                    <div class="prot_content_inner">
                                       <div class="picon"> <a class="portfolio-icon venobox vbox-item" data-gall="myGallery" href="<?= Url::to('@web/images/p6.') ?>"><i class="icofont-image"></i></a></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="pprotfolio4">
