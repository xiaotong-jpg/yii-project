...
<div class="main-slider-area cp10_slider_area">
               ...
               <div class="col-lg-12">
                  <div class="em-nivo-slider-wrapper">
                     <div id="mainSlider_id2" class="nivoSlider em-slider-image">		
                        <img src="<?= Url::to('@web/assets/images/slider1.') ?>"alt="image" title="#htmlcaption1_3936" >				   
                        <img src="<?= Url::to('@web/assets/images/slider2.') ?>"alt="image" title="#htmlcaption1_3935" >
                     </div>
                     <div id="htmlcaption1_3936" class="nivo-html-caption em-slider-content-nivo">
                        <div class="em_slider_inner container  text-center">
                           <div class="wow slideInRight animated" data-wow-duration="2s" data-wow-delay="s" >
                              <h1 class="em-slider-sub-title">The Best Defense Lawyers</h1>
                           </div>
                           <div class="wow slideInRight animated" data-wow-duration="3s" data-wow-delay="s">
                              <p class="em-slider-descript">Law is commonly Understood as a SystemA wonderful serenity has taken of rules that are Created</p>
                           </div>
                           <div class="em-slider-button wow  bounceInUp  em-button-button-area animated" data-wow-duration="3s" data-wow-delay="s" style="visibility: visible; animation-duration: 3s; animation-name: bounceInUp;"> <a class="em-active-button" href="#">Contact Now</a> <a class="withput-active" href="#">About US</a></div>
                        </div>
                     </div>
      ...
      <!-- end slider area -->
      <!-- feature area  -->
      <div class="lorw_service_area home2_service_area">
         <div class="container">
                                 ...
                                 <div class="text_box witr_s_flex">
                                    <div class="service_top_text all_icon_color">
                                       <div class="em-service-icon"> 
                                          <img src="<?= Url::to('@web/assets/images/t1.png') ?>"alt="image" />
                                       </div>
                                    </div>
                                    <div class="em-service-inner">
                                       <div class="em-service-title">
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="service-item all_color_service text-left">
                     <div class="service_top_image"> 
                        <img src="<?= Url::to('@web/assets/images/f1.') ?>"alt="image" />
                     </div>
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="service-item all_color_service text-left">
                     <div class="service_top_image"> 
                        <img src="<?= Url::to('@web/assets/images/f2.') ?>"alt="image" />
                     </div>
                     <div class="text_box all_icon_color">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="service-item all_color_service text-left">
                     <div class="service_top_image"> 
                        <img src="<?= Url::to('@web/assets/images/f3.') ?>"alt="image" />
                     </div>
                     <div class="text_box all_icon_color">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="service-item all_color_service text-left">
                     <div class="service_top_image"> 
                        <img src="<?= Url::to('@web/assets/images/f4.') ?>"alt="image" />
                     </div>
                     <div class="text_box all_icon_color">
                     ...
                     <div class="brand_active">
                        ...
                        <div class="col-lg-12">
                           <div class="slide_items  ">
                              <a href="#"><img src="<?= Url::to('@web/assets/images/br1.') ?>"alt="image"></a>
                           </div>
                        </div>
                        <!-- 02 single brand -->
                        <div class="col-lg-12">
                           <div class="slide_items  ">
                              <a href="#"><img src="<?= Url::to('@web/assets/images/br2.') ?>"alt="image"></a>
                           </div>
                        </div>
                        <!-- 03 single brand -->
                        <div class="col-lg-12">
                           <div class="slide_items  ">
                              <a href="#"><img src="<?= Url::to('@web/assets/images/br3.') ?>"alt="image"></a>
                           </div>
                        </div>
                        <!-- 04 single brand -->
                        <div class="col-lg-12">
                           <div class="slide_items  ">
                              <a href="#"><img src="<?= Url::to('@web/assets/images/br4.') ?>"alt="image"></a>
                           </div>
                        </div>
                        <!-- 05 single brand -->
                        <div class="col-lg-12">
                  ...
                  <div class="choose_img_inner">
                     <div class="single_image_area">
                        <div class="single_image"> 
                           <img src="<?= Url::to('@web/assets/images/skill-thumb1.') ?>"alt="image" />
                        </div>
                     </div>
                  </div>
               </div>
                           ...
                           <div class="row">
                              <div class="col-lg-6 col-md-6">
                                 <div class="single_image_area tab_content_one">
                                    <div class="single_image single_line_option  ">
                                       <img src="<?= Url::to('@web/assets/images/tab-thumb.') ?>"alt="image" />
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-6 col-md-6">
         ...
         <div class="container">
            ...
            <div class="row team_active">
               ...
               <div class="witr_all_mb_30 col-md-12 col-xs-12 col-sm-12 col-lg-12">
                  <div class=" all_color_team ">
                     <div class="witr_team_section"> 
                        <img src="<?= Url::to('@web/assets/images/team-04.') ?>"alt="image" />
                     </div>
               ...
               <div class="witr_all_mb_30 col-md-12 col-xs-12 col-sm-12 col-lg-12">
                  <div class=" all_color_team ">
                     <div class="witr_team_section"> 
                        <img src="<?= Url::to('@web/assets/images/team-05.') ?>"alt="image" />
                     </div>
                     <div class="post_team_content">
                        <div class="post_team_icon_9 all_team_icon_o_color">
                           <ul class="witr_pots_team_s">
               ...
               <div class="witr_all_mb_30 col-md-12 col-xs-12 col-sm-12 col-lg-12">
                  <div class=" all_color_team ">
                     <div class="witr_team_section"> 
                        <img src="<?= Url::to('@web/assets/images/team-06.') ?>"alt="image" />
                     </div>
                     <div class="post_team_content">
                        <div class="post_team_icon_9 all_team_icon_o_color">
                           <ul class="witr_pots_team_s">
      ...
      <div class="lorw_testimonial_area">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                  <div class="witr_section_title">
               ...
               <div class="col-lg-12 ">
                  <div class=" testimonial_active witr_testi_s10">
                     ...
                     <div class="witr_testi_itemt testi-width all_color_testimonial">
                        <div class="em_single_testimonial">
                           <div class="em_test_thumb test-part">
                              <img src="<?= Url::to('@web/assets/images/testi-01.') ?>"alt="image">
                           </div>
                           <div class="em_testi_title">
                              <h2>Rebecca Stevens <span>Diroctore</span></h2>
                           </div>
                           ...
                           <div class="em_testi_content">
                              <div class="em_testi_text">
                                 <p>Following best practices and pro edu izations in the industry, our cles disinf a reader will be distracted discretion admiration in particular.</p>
                              </div>
                           </div>
                           <div class="test-part">
                              <ul>
                     ...
                     <div class="witr_testi_itemt testi-width all_color_testimonial">
                        <div class="em_single_testimonial">
                           <div class="em_test_thumb test-part">
                              <img src="<?= Url::to('@web/assets/images/testi-02.') ?>"alt="image">
                           </div>
                           <div class="em_testi_title">
                              <h2>Nihidan Alex <span>UX Designer</span></h2>
                           </div>
                           <div class="em_testi_logo">
                              <div class="em_testilogo_inner"></div>
                           </div>
                     ...
                     <div class="witr_testi_itemt testi-width all_color_testimonial">
                        <div class="em_single_testimonial">
                           <div class="em_test_thumb test-part">
                              <img src="<?= Url::to('@web/assets/images/testi-03.') ?>"alt="image">
                           </div>
                           <div class="em_testi_title">
                              <h2>Rebecca Stevens <span>CEO & Funder</span></h2>
                           </div>
                           <div class="em_testi_logo">
                              <div class="em_testilogo_inner"></div>
                           </div>
                              ...
                              <div class="prot_thumb">
                                 ...
                                 <div class="prot_content">
                                    <div class="prot_content_inner">
                                       <div class="picon"> <a class="portfolio-icon venobox vbox-item" data-gall="myGallery" href="<?= Url::to('@web/assets/images/p1.') ?>"><i class="icofont-image"></i></a></div>
                                    </div>
                                 </div>
                              </div>
                        ...
                        <div class="grid-item col-lg-4 col-md-6 col-xs-12 col-sm-12 witr_all_mb_30 business_law finalcial_low">
                           <div class="single_protfolio">
                              <div class="prot_thumb">
                                 ...
                                 <div class="prot_content">
                                    <div class="prot_content_inner">
                                       <div class="picon"> <a class="portfolio-icon venobox vbox-item" data-gall="myGallery" href="<?= Url::to('@web/assets/images/p2.') ?>"><i class="icofont-image"></i></a></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="pprotfolio4">
                        ...
                        <div class="grid-item col-lg-4 col-md-6 col-xs-12 col-sm-12 witr_all_mb_30 family_law finalcial_low">
                           <div class="single_protfolio">
                              <div class="prot_thumb">
                                 ...
                                 <div class="prot_content">
                                    <div class="prot_content_inner">
                                       <div class="picon"> <a class="portfolio-icon venobox vbox-item" data-gall="myGallery" href="<?= Url::to('@web/assets/images/p3.') ?>"><i class="icofont-image"></i></a></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="pprotfolio4">
                        ...
                        <div class="grid-item col-lg-4 col-md-6 col-xs-12 col-sm-12 witr_all_mb_30 business_law finalcial_low">
                           <div class="single_protfolio">
                              <div class="prot_thumb">
                                 ...
                                 <div class="prot_content">
                                    <div class="prot_content_inner">
                                       <div class="picon"> <a class="portfolio-icon venobox vbox-item" data-gall="myGallery" href="<?= Url::to('@web/assets/images/p4.') ?>"><i class="icofont-image"></i></a></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="pprotfolio4">
                        ...
                        <div class="grid-item col-lg-4 col-md-6 col-xs-12 col-sm-12 witr_all_mb_30 technology_low">
                           <div class="single_protfolio">
                              <div class="prot_thumb">
                                 ...
                                 <div class="prot_content">
                                    <div class="prot_content_inner">
                                       <div class="picon"> <a class="portfolio-icon venobox vbox-item" data-gall="myGallery" href="<?= Url::to('@web/assets/images/p5.') ?>"><i class="icofont-image"></i></a></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="pprotfolio4">
                        ...
                        <div class="grid-item col-lg-4 col-md-6 col-xs-12 col-sm-12 witr_all_mb_30 technology_low">
                           <div class="single_protfolio">
                              <div class="prot_thumb">
                                 ...
                                 <div class="prot_content">
                                    <div class="prot_content_inner">
                                       <div class="picon"> <a class="portfolio-icon venobox vbox-item" data-gall="myGallery" href="<?= Url::to('@web/assets/images/p6.') ?>"><i class="icofont-image"></i></a></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="pprotfolio4">
