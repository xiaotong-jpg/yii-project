               ...
               <div class="col-md-12 txtc  text-center ccase">
                  ...
                  <div class="breadcumb-inner">
                     <ul>
                        ...
                        <li><span class="current">Four-Column</span></li>
                     </ul>
                  </div>
               </div>
            </div>
      ...
      <div class="lorw_portfolio_area project_area">
         <div class="container-fluid">
            ...
            <div class="row portfolio_active pstyle2">
               <!-- 01 single portfolio -->
               <div class="col-lg-3 col-md-6 grid-item business_law family_law">
               ...
               <!-- 02 single portfolio -->
               <div class="col-lg-3 col-md-6 grid-item  business_law finalcial_low">
                  <div class="single_protfolio">
                     <div class="prot_thumb">
               ...
               <!-- 03 single portfolio -->
               <div class="col-lg-3 col-md-6 grid-item family_law finalcial_low">
                  <div class="single_protfolio">
                     <div class="prot_thumb">
               ...
               <!-- 05 single portfolio -->
               <div class="col-lg-3 col-md-6 grid-item family_law technology_low">
                  <div class="single_protfolio">
                     <div class="prot_thumb">
               ...
               <div class="col-lg-3 col-md-6 grid-item family_law finalcial_low">
                  <div class="single_protfolio">
                     <div class="prot_thumb">
                        <img src="<?= Url::to('@web/assets/images/p7.jpg') ?>"alt="image" />
                        <div class="prot_content">
                           <div class="prot_content_inner">
                              <div class="picon"> 
                                 <a class="portfolio-icon venobox vbox-item" data-gall="myGallery" href="<?= Url::to('@web/assets/images/p7.jpg') ?>"><i class="icofont-image"></i></a>
                              </div>
               ...
               <div class="col-lg-3 col-md-6 grid-item family_law technology_low">
                  <div class="single_protfolio">
                     <div class="prot_thumb">
                        <img src="<?= Url::to('@web/assets/images/p8.jpg') ?>"alt="image" />
                        <div class="prot_content">
                           <div class="prot_content_inner">
                              <div class="picon"> 
                                 <a class="portfolio-icon venobox vbox-item" data-gall="myGallery" href="<?= Url::to('@web/assets/images/p8.jpg') ?>"><i class="icofont-image"></i></a>
                              </div>
